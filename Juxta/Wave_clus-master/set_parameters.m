...
par.sr = 50000;                      % sampling rate (in Hz). This parameter will be only used if the data file don't have a sr. 
 
 
% PLOTTING PARAMETERS 
par.cont_segment = true; 
par.max_spikes_plot = 10000;          % max. number of spikes to be plotted 
...
par.to_plot_std = 5;                 % # of std from mean to plot 
...
par.max_clus = 15;                   % maximum number of clusters allowed (default 200) 
...
par.max_inputs = 0.75;       % number of inputs to the clustering. if < 1 it will be that proportion of the maximum. 
...
par.nbins = 5;                    % # of bins for the ISI histograms 
par.bin_step = .05;                   % percentage number of bins to plot 
