function [starts, stops, centers, warps] = findMotifsJuxta(audioF, templateF, thresh)
% findMotifsJuxta - Identifies motifs in an audio file based on a template.
%
% Inputs:
