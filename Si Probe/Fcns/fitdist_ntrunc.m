...
% Alexey Ryabov. 
%2018/02/08  added the possibility to fit data truncted on the left, right and
%both sides
%2017/08/08
...
% phat -- the maximal likelihood estimates for \mu and \sigma for this distribution 
...
% Range vector with two elements defining the range where the data is truncated
% for instance
...
%The truncated pdf should be normalized. If we truncate from the left, then
